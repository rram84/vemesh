...
- **Flexibility in sequencing primitives**: Element agglomeration and vertex relaxation are complementary operations. Their precise sequencing depends on the choice of quality metric and the goal of mesh improvement. With the stability ratio metric, for instance, agglomeration is far more impactful than relaxation in improving matrix conditioning, see Fig. Hence, VEMesh provides complete freedom in sequencing these, and exposes each operation at three levels of granularity---a single face/vertex, a user-supplied subset, or over the whole mesh by identifying faces with quality falling below a threshold.
